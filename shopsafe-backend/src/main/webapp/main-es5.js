...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _api_api_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./api/api.service */
    "./src/app/api/api.service.ts");
    /* harmony import */


    var _pipes_round_pipe__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./pipes/round.pipe */
    "./src/app/pipes/round.pipe.ts");
    /* harmony import */


    var _components_http_error_http_error_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./components/http-error/http-error.component */
    "./src/app/components/http-error/http-error.component.ts"); // Custom components
  ...
  function srcAppComponentsHttpErrorHttpErrorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HttpErrorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 9,
      vars: 0,
      consts: [["id", "http-error", 1, "segment"], [1, "segment-text"], ["href", "/"]],
  ...
  function srcAppComponentsResultResultComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function ResultComponent_div_0_div_33_Template(rf, ctx) {
      if (rf & 1) {
      ...
      _createClass(ResultComponent, [{
        ...
        value: function getResult() {
          ...
          this.apiService.getNearbyStores(this.location).subscribe(function (data) {
            ...
            console.log(err), _this.httpError = true;
  ...
  function srcAppComponentsStoreStoreComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      _createClass(StoreComponent, [{
        ...
        value: function getStore() {
          ...
          this.apiService.getStoreById(id).subscribe(function (res) {
            ...
            console.log(err), _this2.httpError = true;
          }, function () {
            _this2.initTemplate();
          });
        }
    ...
    StoreComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 3,
      consts: [["id", "store", "class", "segment", 4, "ngIf"], ["class", "loading-screen", "color", "grey", 4, "ngIf"], [4, "ngIf"], ["id", "store", 1, "segment"], [1, "segment-text"], [1, "heading-text"], [1, "back-link", 3, "click"], [1, "fas", "fa-long-arrow-alt-left"], [1, "maps-button", 3, "click"], [1, "stat-bar-wrapper"], [1, "stat-bar"], [1, "stat-elem"], [1, "stat-obj"], [1, "stat-elem", 2, "text-align", "center"], [3, "ngStyle"], [1, "stat-elem", 2, "text-align", "right", "margin-top", "-5px"], [1, "shopsafe-score"], ["id", "check-in-button", 3, "click"], [1, "chart"], ["color", "grey", 1, "loading-screen"]],
      ...
      directives: [_angular_common__WEBPACK_IMPORTED_MODULE_5__["NgIf"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgStyle"], _angular_material_progress_spinner__WEBPACK_IMPORTED_MODULE_6__["MatSpinner"], _http_error_http_error_component__WEBPACK_IMPORTED_MODULE_7__["HttpErrorComponent"]],
