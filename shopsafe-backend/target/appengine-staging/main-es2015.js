...
LandingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LandingComponent, selectors: [["app-landing"]], decls: 14, vars: 0, consts: [["id", "landing", 1, "segment"], [1, "segment-text"], [1, "heading-text"], [1, "fas", "fa-long-arrow-alt-right"], [1, "input-container"], ["type", "text", "placeholder", "ENTER YOUR LOCATION TO FIND NEARBY GROCERY STORES", "name", "search", 1, "input-field"]], template: function LandingComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! /home/raulpalomo/shopsafe/shopsafe-frontend/src/main.ts */"./src/main.ts");
